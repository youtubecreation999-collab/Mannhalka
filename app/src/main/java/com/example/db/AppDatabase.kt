...
@Database(
    entities = [FeelingPost::class, ChatRoom::class, ChatMessage::class, AppSetting::class, ContactEntity::class, UserStats::class, RewardHistory::class, PrivacyLog::class, SecurityLog::class],
    version = 6,
    exportSchema = false
)
